...
public class BookController {
    ...
    public ResponseEntity<ApiResponse<PagedResponse<BookResponse>>> getBooks(
            ...
            @RequestParam(name = "_sort", defaultValue = "bookId") String sort,
        ...
        Page<BookResponse> result = bookService.getBooks(q, categoryName, pageable);

        ApiResponse<PagedResponse<BookResponse>> response = ApiResponse.<PagedResponse<BookResponse>>builder()
                .code(SUCCESS_CODE)
