...
-- 4. PUBLISHER
-- =========================================================
INSERT INTO `publisher` (`publisher_id`, `name`, `contact_email`, `phone`, `address`)
...
-- 5. SUPPLIER
-- =========================================================
INSERT INTO `supplier` (`supplier_id`, `name`, `phone`, `address`)
...
(`promotion_id`, `code`, `discount_percent`, `max_discount_amount`, `min_order_value`, `usage_limit`, `used_count`,
 `start_date`, `end_date`, `status`)
VALUES (1, 'WELCOME10', 10.00, 50000, 100000, 100, 5, '2026-01-01 00:00:00', '2026-12-31 23:59:59', 1),
...
VALUES (1, 1, 'admin01', '$2a$10$adminhash01', 'admin01@bookstore.vn', '0901000001', 'Hà Nội', 'Quản trị viên 01', 0,
        1),
       (2, 2, 'manager01', '$2a$10$managerhash01', 'manager01@bookstore.vn', '0901000002', 'Hà Nội', 'Quản lý 01', 0,
        1),
       (3, 2, 'manager02', '$2a$10$managerhash02', 'manager02@bookstore.vn', '0901000003', 'TP. Hồ Chí Minh',
        'Quản lý 02', 0, 1),
       (4, 3, 'nguyenvana', '$2a$10$userhash01', 'vana@gmail.com', '0901000004', 'Cầu Giấy, Hà Nội', 'Nguyễn Văn A',
        120, 1),
       (5, 3, 'tranthib', '$2a$10$userhash02', 'thib@gmail.com', '0901000005', 'Hai Bà Trưng, Hà Nội', 'Trần Thị B', 80,
        1),
       (6, 3, 'leminhc', '$2a$10$userhash03', 'minhc@gmail.com', '0901000006', 'Đống Đa, Hà Nội', 'Lê Minh C', 40, 1),
       (7, 3, 'phamthud', '$2a$10$userhash04', 'thud@gmail.com', '0901000007', 'Thanh Xuân, Hà Nội', 'Phạm Thu D', 200,
        1),
       (8, 3, 'hoange', '$2a$10$userhash05', 'hoange@gmail.com', '0901000008', 'Long Biên, Hà Nội', 'Hoàng E', 60, 1),
       (9, 3, 'buiducthanh', '$2a$10$userhash06', 'thanh@gmail.com', '0901000009', 'Nam Từ Liêm, Hà Nội',
        'Bùi Đức Thành', 95, 1),
       (10, 3, 'dodiepchi', '$2a$10$userhash07', 'diepchi@gmail.com', '0901000010', 'Hà Đông, Hà Nội', 'Đỗ Diệp Chi',
        30, 1);
...
-- =========================================================
INSERT INTO `book`
(`book_id`, `publisher_id`, `title`, `publication_year`, `language`, `original_price`, `selling_price`, `total_stock`,
 `description`, `cover_image`, `status`)
VALUES (1, 1, 'Cho Tôi Xin Một Vé Đi Tuổi Thơ', 2018, 'Tiếng Việt', 55000, 78000, 20,
        'Tác phẩm nổi tiếng của Nguyễn Nhật Ánh.', 'covers/book1.jpg', 1),
       (2, 3, 'Đắc Nhân Tâm', 2020, 'Tiếng Việt', 60000, 90000, 25, 'Sách kỹ năng giao tiếp kinh điển.',
        'covers/book2.jpg', 1),
       (3, 3, 'Cha Giàu Cha Nghèo', 2021, 'Tiếng Việt', 65000, 98000, 18, 'Sách tài chính cá nhân nổi tiếng.',
        'covers/book3.jpg', 1),
       (4, 6, 'Harry Potter Và Hòn Đá Phù Thủy', 2019, 'Tiếng Việt', 90000, 135000, 15, 'Phần đầu bộ Harry Potter.',
        'covers/book4.jpg', 1),
       (5, 2, 'Dế Mèn Phiêu Lưu Ký', 2017, 'Tiếng Việt', 45000, 68000, 30, 'Tác phẩm thiếu nhi kinh điển.',
        'covers/book5.jpg', 1),
       (6, 4, 'Refactoring', 2022, 'Tiếng Anh', 250000, 320000, 10, 'Cải tiến cấu trúc mã nguồn.', 'covers/book6.jpg',
        1),
       (7, 4, 'Effective Java', 2022, 'Tiếng Anh', 280000, 350000, 12, 'Các thực hành tốt nhất trong Java.',
        'covers/book7.jpg', 1),
       (8, 8, 'Làm Chủ Tư Duy Thay Đổi Vận Mệnh', 2021, 'Tiếng Việt', 70000, 105000, 14, 'Sách phát triển bản thân.',
        'covers/book8.jpg', 1),
       (9, 9, 'Marketing 4.0', 2023, 'Tiếng Việt', 95000, 145000, 16, 'Xu hướng marketing thời đại số.',
        'covers/book9.jpg', 1),
       (10, 5, 'Chí Phèo', 2016, 'Tiếng Việt', 35000, 52000, 22, 'Tác phẩm hiện thực nổi tiếng.', 'covers/book10.jpg',
        1);
...
(`book_item_id`, `book_id`, `barcode`, `condition_type`, `condition_note`, `deposit_amount`, `current_rental_price`,
 `is_for_rent`, `status`, `position`)
VALUES (1, 1, 'BC0001', 'Mới', 'Sách mới 100%', 30000, 10000, 1, 'Sẵn sàng', 'Kệ A1'),
...
-- 10. BOOK_AUTHOR
-- =========================================================
INSERT INTO `book_author` (`book_id`, `author_id`, `author_role`)
...
-- 11. BOOK_CATEGORY
-- =========================================================
INSERT INTO `book_category` (`book_id`, `category_id`, `is_primary`)
VALUES (1, 6, 1),
       (2, 4, 1),
       (3, 2, 1),
       (4, 6, 1),
...
-- 13. CART_ITEM
-- =========================================================
INSERT INTO `cart_item` (`cart_item_id`, `cart_id`, `book_id`, `quantity`)
VALUES (1, 1, 1, 1),
       (2, 1, 2, 2),
       (3, 2, 3, 1),
       (4, 2, 5, 2),
...
-- =========================================================
INSERT INTO `orders`
(`order_id`, `user_id`, `promotion_id`, `points_used`, `promotion_discount_amount`, `point_discount_amount`,
 `total_amount`,
...
-- 15. ORDER_DETAIL
-- =========================================================
INSERT INTO `order_detail` (`order_detail_id`, `order_id`, `book_id`, `quantity`, `unit_price`)
...
-- =========================================================
INSERT INTO `rental`
(`rental_id`, `user_id`, `book_item_id`, `rent_date`, `due_date`, `return_date`, `actual_deposit`, `rental_fee`,
 `penalty_fee`,
 `payment_method`, `payment_status`, `status`)
VALUES (1, 4, 1, '2026-04-01 09:00:00', '2026-04-08 09:00:00', '2026-04-07 10:00:00', 30000, 10000, 0, 'Tiền mặt',
        'Đã hoàn cọc', 'Đã trả'),
       (2, 5, 2, '2026-04-02 10:00:00', '2026-04-09 10:00:00', NULL, 35000, 12000, 0, 'MOMO', 'Đã thu cọc',
        'Đang thuê'),
       (3, 6, 3, '2026-04-03 11:00:00', '2026-04-10 11:00:00', '2026-04-12 12:00:00', 25000, 9000, 5000, 'Tiền mặt',
        'Đã hoàn cọc', 'Đã trả'),
       (4, 7, 4, '2026-04-04 08:30:00', '2026-04-11 08:30:00', NULL, 50000, 15000, 0, 'Banking', 'Đã thu cọc',
        'Quá hạn'),
       (5, 8, 5, '2026-04-05 14:00:00', '2026-04-12 14:00:00', '2026-04-12 13:00:00', 20000, 8000, 0, 'Tiền mặt',
        'Đã hoàn cọc', 'Đã trả'),
       (6, 9, 6, '2026-04-06 15:00:00', '2026-04-13 15:00:00', NULL, 80000, 25000, 0, 'MOMO', 'Đã thu cọc',
        'Đang thuê'),
       (7, 10, 7, '2026-04-07 16:00:00', '2026-04-14 16:00:00', NULL, 90000, 30000, 0, 'Banking', 'Đã thu cọc',
        'Đang thuê'),
       (8, 4, 8, '2026-04-08 09:30:00', '2026-04-15 09:30:00', '2026-04-15 10:00:00', 30000, 10000, 0, 'Tiền mặt',
        'Đã hoàn cọc', 'Đã trả'),
       (9, 5, 9, '2026-04-09 10:30:00', '2026-04-16 10:30:00', NULL, 45000, 14000, 0, 'MOMO', 'Đã thu cọc',
        'Đang thuê'),
       (10, 6, 10, '2026-04-10 13:00:00', '2026-04-17 13:00:00', NULL, 15000, 7000, 10000, 'Tiền mặt', 'Đã thu cọc',
        'Quá hạn');
...
-- =========================================================
INSERT INTO `book_import` (`import_id`, `supplier_id`, `user_id`, `import_date`, `total_cost`)
VALUES (1, 1, 2, '2026-03-01 09:00:00', 1200000),
...
-- 18. IMPORT_DETAIL
-- =========================================================
INSERT INTO `import_detail` (`import_detail_id`, `import_id`, `book_id`, `quantity`, `import_price`)
VALUES (1, 1, 1, 10, 55000),
       (2, 2, 2, 15, 60000),
       (3, 3, 3, 12, 65000),
       (4, 4, 4, 8, 90000),
       (5, 5, 5, 20, 45000),
...
(`log_id`, `user_id`, `book_item_id`, `action_type`, `reference_order_id`, `reference_import_id`, `reference_rental_id`,
 `note`)
...
-- 21. REVIEW
-- =========================================================
INSERT INTO `review` (`review_id`, `user_id`, `book_id`, `rating`, `comment`, `is_approved`)
VALUES (1, 4, 1, 5, 'Sách rất hay và cảm động.', 1),
...
-- 23. CHAT_SESSION
-- =========================================================
INSERT INTO `chat_session` (`session_id`, `user_id`, `started_at`, `ended_at`, `status`)
...
-- 24. CHAT_MESSAGE
-- =========================================================
INSERT INTO `chat_message` (`message_id`, `session_id`, `sender_type`, `content`)
